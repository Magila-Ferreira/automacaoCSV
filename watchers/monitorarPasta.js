...
const { processarArquivo, tratarCamposVazios, filtrarRegistrosNovos, filtrarRegistrosDublicados } = require('../services/lerArquivos');
const { criarBancoEDefinirTabelas, salvarDados, recuperarDadosDoBanco } = require('../models/operacoesBanco');
